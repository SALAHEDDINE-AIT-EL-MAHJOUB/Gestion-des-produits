          ...
          <li style={{ marginBottom: "22px" }}>
            <Link
              ...
              onMouseOver={e => {
                ...
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 4px 18px rgba(39,174,96,0.18)";
              }}
              onMouseOut={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)";
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 2px 12px rgba(39,174,96,0.10)";
              }}
            >
              {FaIcons.FaBoxOpen({ size: 24 })}
              Produits
            </Link>
          </li>
          <li>
            <Link
              ...
              onMouseOver={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1.05)";
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 4px 18px rgba(241,196,15,0.18)";
              }}
              onMouseOut={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)";
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 2px 12px rgba(241,196,15,0.10)";
              }}
            >
              {FaIcons.FaListAlt({ size: 24 })}
              Listes de produits
            </Link>
          </li>
        </ul>
